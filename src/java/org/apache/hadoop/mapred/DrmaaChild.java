 ...
 * This is a special version of a Child that is capable of running on a remote location.
 * This Child gets the following configuration via args:
 * args[0] host name of tasktracker
 * args[1] host port of tasktracker
 * args[2] task attempt id (used to get the task from task tracker)
 * args[3] log location
 * args[4] jvmId (ignored)
 */

class DrmaaChild {

  public static final Log LOG =
    LogFactory.getLog(DrmaaChild.class);
  ...
  public static void main(String[] args) throws Throwable {
    ...
    LOG.info("DrmaaChild starting with ARGUMENTS =" + org.apache.commons.lang.StringUtils.join(args, ", "));
    ...
    // todo: check if loglocation is set for remote child
    final String logLocation = args[3];

    LOG.info("Remote child LOG LOCATION: "+logLocation);
    LOG.info("Remote task id = " + args[2]);
    LOG.info("Remote taskAttemptId" + firstTaskid != null ? firstTaskid.toString() : "null");
